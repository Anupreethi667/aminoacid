...
<body>
<p style="text-align:center; font-size:50px; color:#363636 "> Glucogenic and Ketogenic Amino Acids  </p>
</body>
...
$sql = "select * FROM metabolic_fate WHERE metabolic_fate='Glucogenic and Ketogenic'";
