...
<head> 
    ...
    <link rel="stylesheet" type="text/css" href="css_struct_basic/css_cysteine_basic_struct.css">
</head> 
...
if($link === false){
 ...
 $sql = "SELECT amino_acid.*, structure.structure_type, structure.description, structure.chemical_formula, structure.about FROM structure JOIN amino_acid ON amino_acid.amino_acid=structure.amino_acid WHERE amino_acid.amino_acid='Cysteine'";
;
    ...
    if(mysqli_num_rows($result) > 0){
	    echo "<table>";
            echo "<tr>";
                ...
                echo "<th style='font-size:50px'>Cysteine</th>";
            echo "</tr>";
