...
<p style="font-size:70px; color:white"> Non-Essential Amino Acids </p>
</body>
...
$sql = "select * FROM nutritional_requirement WHERE nutritional_requirement.nutritional_requirement ='Non essential'";
